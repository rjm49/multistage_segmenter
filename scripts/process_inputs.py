...
if __name__ == '__main__':
    ...
    lm_dir = raw_input("Type in LM dir or hit return to use default [%s]" % lm_dir) or lm_dir
    print "using ",lm_dir
    
    lm_dir = raw_input("Type in SLM dir or hit return to use default [%s]" % slm_dir) or slm_dir
    print "using ",slm_dir
